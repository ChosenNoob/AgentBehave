 ...
 * </p>
 * <ul>
 *   <li>{@link metamodel.impl.CompositeNodeImpl#getSubtree <em>Subtree</em>}</li>
 *   <li>{@link metamodel.impl.CompositeNodeImpl#getCompositeChild <em>Composite Child</em>}</li>
 *   <li>{@link metamodel.impl.CompositeNodeImpl#getConditionChild <em>Condition Child</em>}</li>
 *   <li>{@link metamodel.impl.CompositeNodeImpl#getActionChild <em>Action Child</em>}</li>
 * </ul>
 *
 * @generated
 */
public abstract class CompositeNodeImpl extends MinimalEObjectImpl.Container implements CompositeNode {
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.COMPOSITE_NODE;
	}
	...
	public EList<Tree> getSubtree() {
		if (subtree == null) {
			subtree = new EObjectContainmentEList<Tree>(Tree.class, this, MetamodelPackage.COMPOSITE_NODE__SUBTREE);
		}
		return subtree;
	}
	...
	public EList<CompositeNode> getCompositeChild() {
		if (compositeChild == null) {
			compositeChild = new EObjectContainmentEList<CompositeNode>(CompositeNode.class, this,
					MetamodelPackage.COMPOSITE_NODE__COMPOSITE_CHILD);
		}
	...
	public EList<ConditionNode> getConditionChild() {
		if (conditionChild == null) {
			conditionChild = new EObjectContainmentEList<ConditionNode>(ConditionNode.class, this,
					MetamodelPackage.COMPOSITE_NODE__CONDITION_CHILD);
		}
	...
	public EList<ActionNode> getActionChild() {
		if (actionChild == null) {
			actionChild = new EObjectContainmentEList<ActionNode>(ActionNode.class, this,
					MetamodelPackage.COMPOSITE_NODE__ACTION_CHILD);
		}
		return actionChild;
	}
