 ...
 * </p>
 * <ul>
 *   <li>{@link metamodel.impl.TreeImpl#getCompositeChild <em>Composite Child</em>}</li>
 *   <li>{@link metamodel.impl.TreeImpl#getSubtree <em>Subtree</em>}</li>
 *   <li>{@link metamodel.impl.TreeImpl#getActionChild <em>Action Child</em>}</li>
 *   <li>{@link metamodel.impl.TreeImpl#getName <em>Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class TreeImpl extends MinimalEObjectImpl.Container implements Tree {
	...
	protected EClass eStaticClass() {
		return MetamodelPackage.Literals.TREE;
	}
	...
	public EList<CompositeNode> getCompositeChild() {
		if (compositeChild == null) {
			compositeChild = new EObjectContainmentEList<CompositeNode>(CompositeNode.class, this,
					MetamodelPackage.TREE__COMPOSITE_CHILD);
		}
	...
	public EList<Tree> getSubtree() {
		if (subtree == null) {
			subtree = new EObjectContainmentEList<Tree>(Tree.class, this, MetamodelPackage.TREE__SUBTREE);
		}
		return subtree;
	}
	...
	public EList<ActionNode> getActionChild() {
		if (actionChild == null) {
			actionChild = new EObjectContainmentEList<ActionNode>(ActionNode.class, this,
					MetamodelPackage.TREE__ACTION_CHILD);
		}
		return actionChild;
	}
	...
	public void setName(String newName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, MetamodelPackage.TREE__NAME, oldName, name));
	}
