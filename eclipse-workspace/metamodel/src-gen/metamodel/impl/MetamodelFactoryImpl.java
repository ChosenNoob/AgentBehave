...
public class MetamodelFactoryImpl extends EFactoryImpl implements MetamodelFactory {
	...
	public EObject create(EClass eClass) {
		...
		case MetamodelPackage.ROOT:
			return createRoot();
		case MetamodelPackage.TREE:
			return createTree();
		case MetamodelPackage.FALLBACK_NODE:
			return createFallbackNode();
		case MetamodelPackage.SEQUENCE_NODE:
			return createSequenceNode();
		case MetamodelPackage.CONDITION_NODE:
			return createConditionNode();
		case MetamodelPackage.ACTION_NODE:
