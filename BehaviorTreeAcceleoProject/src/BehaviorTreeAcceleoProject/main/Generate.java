 ...
 *******************************************************************************/
package BehaviorTreeAcceleoProject.main;
...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/BehaviorTreeAcceleoProject/main/generate";
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(behaviorModel.BehaviorModelPackage.class)) {
            resourceSet.getPackageRegistry().put(behaviorModel.BehaviorModelPackage.eINSTANCE.getNsURI(), behaviorModel.BehaviorModelPackage.eINSTANCE);
        }
