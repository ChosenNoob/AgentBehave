...
public class Generate extends AbstractAcceleoGenerator {
     ...
     * @generated
     */
    public static final String MODULE_FILE_NAME = "/behaviortree/generator/main/generate";
...
//      model.setProjectPath(targetFolder.getParentFile().getPath());
        model.setProjectPath(targetFolder.getParentFile().getParentFile().getPath());
    }
    ...
    public void registerPackages(ResourceSet resourceSet) {
        ...
        if (!isInWorkspace(behaviortree.BehaviortreePackage.class)) {
            resourceSet.getPackageRegistry().put(behaviortree.BehaviortreePackage.eINSTANCE.getNsURI(), behaviortree.BehaviortreePackage.eINSTANCE);
        }
