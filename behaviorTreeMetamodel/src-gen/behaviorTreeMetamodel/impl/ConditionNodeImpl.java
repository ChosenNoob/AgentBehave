 ...
 * </p>
 * <ul>
 *   <li>{@link behaviorTreeMetamodel.impl.ConditionNodeImpl#getConditionName <em>Condition Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ConditionNodeImpl extends MinimalEObjectImpl.Container implements ConditionNode {
	...
	protected EClass eStaticClass() {
		return BehaviorTreeMetamodelPackage.Literals.CONDITION_NODE;
	}
	...
	public void setConditionName(String newConditionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET,
					BehaviorTreeMetamodelPackage.CONDITION_NODE__CONDITION_NAME, oldConditionName, conditionName));
	}
