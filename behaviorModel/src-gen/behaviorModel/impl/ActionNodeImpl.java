 ...
 * </p>
 * <ul>
 *   <li>{@link behaviorModel.impl.ActionNodeImpl#getActionName <em>Action Name</em>}</li>
 * </ul>
 *
 * @generated
 */
public class ActionNodeImpl extends MinimalEObjectImpl.Container implements ActionNode {
	...
	protected EClass eStaticClass() {
		return BehaviorModelPackage.Literals.ACTION_NODE;
	}
	...
	public void setActionName(String newActionName) {
		...
		if (eNotificationRequired())
			eNotify(new ENotificationImpl(this, Notification.SET, BehaviorModelPackage.ACTION_NODE__ACTION_NAME,
	...
	public Object eGet(int featureID, boolean resolve, boolean coreType) {
		switch (featureID) {
		case BehaviorModelPackage.ACTION_NODE__ACTION_NAME:
	...
	public Object eInvoke(int operationID, EList<?> arguments) throws InvocationTargetException {
		switch (operationID) {
		case BehaviorModelPackage.ACTION_NODE___OPERATION:
			operation();
			return null;
		}
